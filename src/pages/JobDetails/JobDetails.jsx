...
const JobDetails = () => {
    ...
    return (
        <div className="card bg-base-100 max-w-md mx-auto my-24 shadow-sm border">
            ...
            <div className="card-body">
                ...
                <NavLink to={`/apply/${_id}`}><button className='btn w-full mt-4 btn-primary'>Apply Now</button></NavLink>
            </div>
        </div>
    );
};
